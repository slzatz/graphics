...
public:
 bool OnUserCreate() override
 {
  ...
  // fFar = 1000
  // field of view = 90
  // aspect ratio = ScreenHeight/ScreenWidth
...
//#ifdef DO_TEXTURE_DEMO
  fTheta += 0.25f * fElapsedTime; // Uncomment to spin me right round baby right round //1.0
//#endif
  ...
  return true;
 } // end of bool OnUserUpdate(float fElapsedTime) override

}; // end of class olcEngine3D : public olc::PixelGameEngine
